...
3. Validating the completed specification.
4. Building and publishing the completed specification for public viewing.
...
3. [Redocly CLI](https://redocly.com/docs/cli)
      - For linting and building the completed specification into a html file for publishing.
4. GitHub
